...
psnr_without_normalization = psnr(ink_patch, reg_patch, data_range=255)
psnr_normalization = psnr(ink_patch_norm, reg_patch_norm, data_range=255)

vif_without_normalization = vif(ink_patch, reg_patch)
vif_normalization = vif(ink_patch_norm, reg_patch_norm)

# print(ssim_)

print("SSIM:\nWithout normalization: {}\nWith normalization: {}\n".format(ssim_without_normalization,ssim_normalization))
# print("ssim_src: {}\nwith normalization: {}".format(ssim_src,ssim_src_norm))
print("PSNR:\nWithout normalization: {}\nWith normalization: {}".format(psnr_without_normalization,psnr_normalization))
print("VIF:\nWithout normalization: {}\nWith normalization: {}".format(vif_without_normalization,vif_normalization))
